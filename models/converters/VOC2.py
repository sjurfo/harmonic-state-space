...
def main():
    ...
    sweep = ParametricSweep(voc)
    #sweep.eigenloci(np.linspace(0.01, 0.2, 30))
    sweep.eigenloci(np.flip(np.logspace(-5,-2, 30)))
    #sweep.eigenloci(np.linspace(1, 100, 30))
    sweep.eigenloci_plot()
    #sweep.sweep([np.flip(np.linspace(0.2, 5, 30)), np.flip(np.linspace(20, 150, 30))])
