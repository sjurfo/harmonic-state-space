...
def main():
    ...
    param_sweep = ParametricSweep(voc)
    #param_sweep.eigenloci(np.linspace(0.01, 0.2, 30))
    param_sweep.eigenloci(np.flip(np.logspace(-5,-2, 30)))
    #param_sweep.eigenloci(np.linspace(1, 100, 30))
